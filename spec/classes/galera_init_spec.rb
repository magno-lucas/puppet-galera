    ...
    context "on #{os}" do
      ...
      let (:os_params) do
        if facts[:osfamily] == 'RedHat'
						{ :p_mysql_package_name  => 'Percona-XtraDB-Cluster-server-56',
            :p_galera_package_name => 'Percona-XtraDB-Cluster-galera-3',
            :p_client_package_name => 'Percona-XtraDB-Cluster-client-56',
          ...
          { :p_mysql_package_name  => 'percona-xtradb-cluster-server-5.6',
            :p_galera_package_name => 'percona-xtradb-cluster-galera-3',
            :p_client_package_name => 'percona-xtradb-cluster-client-5.6',
